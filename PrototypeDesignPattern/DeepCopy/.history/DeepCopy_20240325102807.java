public class ShallowCopy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Truoc khi gan gia tri");
...
class Person {
    ...
    public Person clone() {
        Person clonedPerson = new Person(this.name, 0); // 0 là giá trị tạm thời cho tuổi
        clonedPerson.setAddress(this.address.clone());
        return clonedPerson;
    }
